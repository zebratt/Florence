...
class PersonalCenter extends Component {
    ...
    render() {
        ...
        const { customerId, cwpCustomers: { customerName, customerPhone } } = this.props
        ...
        if (!customerId) {
            ...
            tabContent = (
                <div className="content">
                    ...
                    <Route path="/personal/charge" component={Charge} />
                    <Route path="/personal/withdraw" component={Withdraw} />
                </div>
            )
        }
                ...
                <div className="main">
                    <div className="menu">
                        ...
                        <div className="profile">
                            <p>欢迎您：{customerPhone}</p>
                            <p>交易账户：{customerName}</p>
                        </div>
                        <div className="menus">
                            {tabs.map(tab => {
