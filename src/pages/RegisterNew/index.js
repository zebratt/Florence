...
import { URL_REGISTER_NEW, URL_SEND_VERITY_CODE } from '../../utils/urls'
...
class Register extends Component {
    ...
    onNextHandler = () => {
        const { phone, password, passwordConfirm, checkStatus, verifyCodeVal, isSubmiting, broker } = this.state
    ...
    onChangeHandler = (eve) => {
        switch (eve.target.className) {
            ...
            case 'broker':
                this.setState({
                    broker: eve.target.value
                })
        }
    }

    render() {
        const { phone, password, passwordConfirm, checkStatus, verifyUnderCounting, verifyText, verifyCodeVal, isSubmiting, broker } = this.state
